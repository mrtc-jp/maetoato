...
function theme_enqueue_styles() {
	...
	wp_enqueue_style( 'write-style', get_stylesheet_directory_uri() . '/style.css',  array(), '1.0.5' );
	...
	wp_enqueue_script( 'original-js', get_stylesheet_directory_uri() . '/js/original.js', array(), '1.0.5', true );
}
